...
;(function(global, factory) {
	...
	var pinyinUtil =
	{
		 ...
		 * @param getPreciseName 是否获取精确的拼音
		 */
		getPinyin: function(chinese, splitter, withtone, polyphone, getPreciseName)
		{
			...
			{
				if(window.pinyin_dict_polyphone && getPreciseName) return parsePolyphone(chinese, result, splitter, withtone);
